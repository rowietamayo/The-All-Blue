...
export default function Home() {
  ...
  const hasOrders =
    !!currentUser && Array.isArray(userOrders) && userOrders.length > 0
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-y-8 md:gap-y-0 text-center">
              <div className="animate-in fade-in zoom-in duration-500 delay-100 border-r border-border/50">
                <p
                  className="text-4xl font-serif text-accent mb-2"
                  data-testid="stat-menu-items"
                >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">
              The most sought-after treasures of the sea.
            </p>
          </div>
          ...
          <div className="text-center mt-12">
            <Link href="/menu">
              <Button
                size="lg"
                className="bg-primary hover:bg-primary/90 text-primary-foreground font-medium rounded-full px-8 shadow-md"
              >
                View Full Menu
              </Button>
            </Link>
